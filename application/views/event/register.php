<div class="col-md-10 col-md-offset-1">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <hr />
            <form class="form-horizontal" method="post" action="<?php echo site_url('event/registerFamily') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 col-md-offset-0">
                        <input type="text" name="family_id" readonly class="form-control" value="<?php echo $this->data['family_id'] ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-2">
